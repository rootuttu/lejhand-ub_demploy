...
RUN git clone https://github.com/rootuttu/lejhand_ub
...
RUN git clone https://github.com/rootuttu/lejhand_ub /root/raikwayFuckt
RUN mkdir /root/raikwayFuckt/bin/
WORKDIR /root/raikwayFuckt/
